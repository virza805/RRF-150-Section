...
<div class="container_full d_back " style ='margin-top: 0px;'>
	...
	<!-- Side bar Section end-->	
			<div class="col-md-9">
				...
				<div class="row">
					<div class="col-6 fix"> 
						<h4><b class="text-info">Add Student to History Details</b></h4>
						  ...
						  <?php
							...
							$result = mysqli_query($db,"INSERT INTO save (RNO,NAMES,FNAME,DOB,GEN,PHO,MAIL,ADDR,SCLASS,SSEC,SIMG,MNAME,CRNO,YE,PASS,REL,TID) VALUES('$rno','$name','$fname','$edate','$gen','$pho','$email','$addr','$cla','$sec','$target_file','$mname','$ro','$year','$rno','$rel','{$_SESSION["TID"]}')");
							if($result){
					...
					<div class="col-6 text-center rboxl">
						...
						<?php 
						 ...
						 ?>
						 <br>
						 <input type="email" name="email" placeholder="Parent's Email" value="g@g.com" required class="input form-control"><br>
							...
							if($r->num_rows>0){
							 ...
							 <input type="text" name="relic" placeholder="Religion" required class="input form-control"><br>
