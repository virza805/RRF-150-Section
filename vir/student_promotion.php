...
<!-- This is Promotion test Start Right Now -->
			<div class="col-md-6 mt-5">
			<h3><b class="text-info">Class ways Promotion Details</b></h3>
						  ...
						  <?php 
						   ...
						   ?>
						<form  role="form" method="get" action="all-student-promoted-test.php"><br>
...
<!-- This is Promotion test End Hear -->
	<!-- Side bar Section end-->	
			<div class="col-md-12">
				<h2 class="text-light">Welcome Admin </h2>
				<div class="row">
					<div class="col-md-12 fix"> 
						<h4><b class="text-info">Admin Single Student Promotion Details</b></h4>
									...
									while($r=$re->fetch_assoc()){
										...
										echo "
											<tr>
										        ...
										        <td>
										          <a href='students_promotion.php?editid={$r["ID"]}' target='_blank'  class='btn btn-success '>Promotion</a>
										        </td>
										        <td>
                                                <a href='edit_student_img.php?editid={$r["ID"]}' target='_blank' class='btn btn-success '>Img</a>
										        </td>
											</tr>
										";
									}
