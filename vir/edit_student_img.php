...
$query ="UPDATE student SET NAME='$btu', FNAME='$etu', DOB='$mtu', PHO='$stu', MAIL='$sotu', ADDR='$rtu', SCLASS='$atu', SSEC='$ict', MNAME='$e', CRNO='$m', YEAR='$s', PASS='$so', GEN='$gen', SIMG='$target_file' WHERE ID='$editid' ";
							  	...
							  	<form enctype='multipart/form-data' role='form' method='post' action=' '>
							  		 <tr>
								        ...
								        <td><input type="text" class="form-control" id="btu" placeholder="Edit Name" name="en" value="<?php echo $result['NAME'] ?>"> </td>
								      	...
								      	<th>Class</th>
								        <td><input type="text" class="form-control" id="btu" placeholder="Edit Class" name="ec" value="<?php echo $result['SCLASS'] ?>"></td>
								      </tr>
								      <tr>
								      	<th>Section</th>
								        <td><input type="text" class="form-control" id="btu" placeholder="Edit Class Section" name="ess" value="<?php echo $result['SSEC'] ?>"></td>
								      	<th>Class Roll</th>
								    ...
								    <tr>
								     ...
								     <tr>
								      ...
								      <td>
                                        <input type="file" name="img" required class="input form-control" value="<?php echo $result['SIMG'] ?>">
                                      </td>
