					...
					<div class="col-6 fix"> 
						<h4><b class="text-info">Add Student Details</b></h4>
						  ...
						  <?php
							...
							$result = mysqli_query($db,"INSERT INTO student (RNO,NAME,FNAME,DOB,GEN,PHO,MAIL,ADDR,SCLASS,SSEC,SIMG,MNAME,CRNO,YEAR,PASS,REL,TID) VALUES('$rno','$name','$fname','$edate','$gen','$pho','$email','$addr','$cla','$sec','$target_file','$mname','$ro','$year','$rno','$relii','{$_SESSION["TID"]}')");
							if($result){
