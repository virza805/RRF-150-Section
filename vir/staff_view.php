	...
	<!-- Side bar Section end-->	
			<div class="col-md-9">
				...
				<div class="row">
					...
					<h2 class="p-2"><b><?php echo $row["DGN"] ?></b></h2>
					...
					<div class="col-8 text-center rboxl">
						...
						<table border="1px" class="bg-light ml-4 m-2 p-4 form-control ">
							<tr>
								<th class="p-2"><b><?php echo $row["DGN"] ?></b></th>
							...
							<tr>
								...
								<td class="p-2"><?php echo $row["TID"] ?></td>
							</tr>
							<tr>
								<th class="p-2">Password.</th>
								<td class="p-2"><?php echo $row["TPASS"] ?></td>
								
							</tr>
							<tr>
								<th class="p-2">Designation</th>
								<td class="p-2"><?php echo $row["DGN"] ?></td>
