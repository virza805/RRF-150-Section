					...
					<table class="table table-bordered table-sm"  id="za" >
                        <thead>
							<tr>
                                ...
                                <th>English</th>
                                <th>Mathematics</th>
                                <th>Religion & Moral Edu.</th>
                                <th>Drawing & Hand Writing</th>
                                <th>Total</th>
                                <th>GPA</th>
                                <th>GP</th>
                                <th>Pos</th>
...
<!-- Drawing & Hand Writing -->    
      <?php 
       $total = $tuban+$tueng+$tumat+$turel+$tuagr;
       $svg = $total/5;
       $total_point = $bpoi+$epoi+$mpoi+$rpoi+$apoi;
       
       $gpoint =$total_point/5;
 
       $gpoint = include "search_fall_play_kg.php";
      ...
      <td>
      <a href="admin_edit_viwe_result.php?editid=<?php echo $rows['SMID'] ?>" target='_blank' class='text-success '><i class='fas fa-graduation-cap'></i></a>
      </td>
                                        </tr>
