...
<!-- Drawing & Hand Writing -->    
      <?php 
       $total = $tuban+$tueng+$tumat+$turel+$tusci+$tuacc+$tuagr;
       $svg = $total/7;
       $total_point = $bpoi+$epoi+$mpoi+$rpoi+$spoi+$acpoi+$apoi;
      ...
      <td>
      <a href="admin_edit_viwe_result.php?editid=<?php echo $rows['SMID'] ?>" target='_blank' class='btn btn-success '><i class='fas fa-laptop-code'></i></a>
      </td>
                                        </tr>
