  ...
  <tbody>
    ...
    <tr>
     ...
     $h_mark = $ws['hight_mark']*1;
      ...
      $hight_mark =$obj_h_mark+round($h_mark);
      ...
      $all_bangla= $ba_mcq+$ba_wr+$b_mcq+$b_wr;
        $t_bangla = $all_bangla/2;
        $bangla = round($t_bangla);
        $avg = $bangla;

        $point=$bangla;

        $bangla_point = include "nt_ban_point.php";

        $bangla_point =$get_point;

       ?>

      <td rowspan="2" ><?php include "nt_ban_grate.php"; ?></td>

      <td rowspan="2" ><?php include "nt_ban_show_point.php"; ?></td>
...
?>
      ...
      <?php
        ...
        $engla_point = include "nt_eng_point.php";

        $engla_point =$get_point;

       ?>

      <td rowspan="2" ><?php include "nt_eng_grate.php"; ?></td>

      <td rowspan="2" ><?php include "nt_eng_show_point.php"; ?></td>
...
<!-- End English 2nd ---- End English 2nd ---- End English 2nd ---- End English 2nd -->
...
<td><?php include "nt_grate.php"; ?></td>

<td><?php include "nt_show_point.php"; ?></td>
